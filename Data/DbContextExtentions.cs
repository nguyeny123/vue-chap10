        ...
        var products = new List<Product>()
        {
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              new ProductVariant
              {
                ...
                Storage = context.Storage.Single(s => s.Capacity == 32.ToString()),
                Price = 299M
              },
              new ProductVariant
              {
                Colour = context.Colours.Single(c => c.Name == "Black"),
                Storage = context.Storage.Single(s => s.Capacity == 64.ToString()),
                Price = 349M
              },
              new ProductVariant
              {
          ...
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              new ProductVariant
              {
                ...
                Storage = context.Storage.Single(s => s.Capacity == 8.ToString()),
                Price = 149M
              },
              new ProductVariant
              {
                Colour = context.Colours.Single(c => c.Name == "White"),
                Storage = context.Storage.Single(s => s.Capacity == 16.ToString()),
                Price = 169M
              },
              new ProductVariant
              {
          ...
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              new ProductVariant
              {
                ...
                Storage = context.Storage.Single(s => s.Capacity == 4.ToString()),
                Price = 99M
              },
              new ProductVariant
              {
          ...
          new Product
          {
            ...
            ProductVariants = new List<ProductVariant>
            {
              ...
              {
                Colour = context.Colours.Single(c => c.Name == "Black"),
                Storage = context.Storage.Single(s => s.Capacity == 128.ToString()),
                Price = 799M
              },
              new ProductVariant
              {
                Colour = context.Colours.Single(c => c.Name == "Black"),
                Storage = context.Storage.Single(s => s.Capacity == 256.ToString()),
                Price = 899M
              },
              new ProductVariant
              {
