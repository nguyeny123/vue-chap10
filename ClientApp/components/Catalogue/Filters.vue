...
<multi-select-filter slot="body" queryKey="brands" :items="filters.brands" />
</filter-accordion>
...
<b-col cols="6">
<div :class="{ 'filter-item': true,
'active': capacity.length === 0 }" @click="clearCapacity">All</div>
</b-col>
<b-col cols="6" v-for="item in filters.storage" :key="item">
<div :class="{ 'filter-item': true, 'active':
capacity.indexOf(item) > -1 }" @click="filterCapacity(item)">
{{ item }}</div>
</b-col>
</b-row> -->
...
<b-col cols="6">
<div :class="{ 'filter-item': true,
'active': colours.length === 0 }" @click="clearColours">All</div>
</b-col>
...
<div :class="{ 'filter-item': true, 'active':features.indexOf(item) > -1 }"
@click="filterFeature(item)">{{ item }}
</div>
</b-col>
</b-row> -->
<multi-select-filter slot="body" query-key="features" :items="filters.feature" />
</filter-accordion>
...
components: {
FilterAccordion,MultiSelectFilter,RangeFilter
},
// computed: {
//     brands() {
