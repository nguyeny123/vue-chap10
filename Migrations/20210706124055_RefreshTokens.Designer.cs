...
namespace test3.Migrations
{
    ...
    [Migration("20210706124055_RefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.OrderItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.Orderss", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.OrderItems", b =>
                {
                    b.HasOne("ECommerce.Data.Entities.Orders.Orderss")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Orders.Orderss", b =>
                {
                    ...
                    b.OwnsOne("ECommerce.Data.Entities.Orders.Addresss", "DeliveryAddress", b1 =>
                        {
                            b1.Property<int>("OrderssId");
                            ...
                            b1.HasOne("ECommerce.Data.Entities.Orders.Orderss")
                                .WithOne("DeliveryAddress")
                                .HasForeignKey("ECommerce.Data.Entities.Orders.Addresss", "OrderssId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
